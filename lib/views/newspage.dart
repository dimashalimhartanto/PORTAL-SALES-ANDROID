...
class BeritaSekarang extends StatefulWidget {
  @override
  _BeritaSekarangState createState() => _BeritaSekarangState();
}

class _BeritaSekarangState extends State<BeritaSekarang> {
  bool _loading;
  var newslist;
