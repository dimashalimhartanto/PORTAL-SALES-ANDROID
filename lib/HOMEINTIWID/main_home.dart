...
import 'package:PortalSales/HOMEINTIWID/blogListHome.dart';
import 'package:PortalSales/REPORT_INTIWID/youtubepromotion.dart';
import 'package:PortalSales/home_screen_utama.dart';

void main() => runApp(DetailHomePasien());

class DetailHomePasien extends StatelessWidget {
  @override
              ...
              children: <Widget>[
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => HomeWorklist()),
                    );
                  },
                  child: Icon(
                    Icons.arrow_back,
    ...
    return Padding(
      ...
      child: new RaisedButton(
        ...
        onPressed: () => Navigator.push(
            context, MaterialPageRoute(builder: (context) => BlogListPasien())),
